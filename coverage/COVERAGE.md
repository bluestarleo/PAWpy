...
| tm1-proxy | 2.0.0 | TM1ProxyService | baseline (TM1 REST via proxy) |
...
## TM1 proxy — `/api/v0/tm1/{db}/api/v1/...`
...
Diff hits under this prefix are TM1 REST endpoints (TM1py territory), not new
*PAW* surface — triage them as "covered by generic proxy" unless a typed
convenience method is wanted.
